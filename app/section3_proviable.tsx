  ...
  return (
    <div className={classes.container}>
      <div className={classes.section1}>
        ...
        <div className={classes.sign_in_txt}>
          Sign-in to your account on the MyNutramax dashboard for exclusive
          Proviable<sup>®</sup> content.
        </div>
        <Link
          className={classes.button}
          href="https://www.mynutramax.com/dashboard/?#resources:proviable"
          target="_blank"
